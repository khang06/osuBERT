...
class DataConfig:
    ...
    add_out_context_types: bool = False  # Add tokens indicating types of the out context
...
cs.store(group="osubert", name="base_train", node=TrainConfig)
